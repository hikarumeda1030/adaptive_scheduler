...
def save_to_csv(csv_path, results: TrainingResults):
    headers = {
        ...
        "sfo": ['Batch Size', 'Epsilon', 'Epoch', 'Total Steps', 'Steps by BS', 'SFO'],
        "norm_steps": ['Epoch', 'Steps', 'Full Gradient Norm'],
        "train_steps": ['Epoch', 'Steps', 'Train Loss', 'Train Accuracy', 'Learning Rate']
    }
